...
async function checkForUpdates(cfg, tree) {
  ...
  try {
    ...
    sendUpdateStatus({ status: 'updating', version: newestVersion, message: `Downloading update ${newestVersion}...` });
    ...
    sendUpdateStatus({
      ...
      message: needsElevation
        ...
        : `Updating to version ${newestVersion}... the launcher will restart shortly.`,
    });
